...
const Profile = ({ doctorData }) => {
  ...
  const updateDoctorHandler = async (e) => {
    e.preventDefault();
    try {
      console.log(`Updating details for doctor with id: ${formData.email}`);
      console.log(`Time Slots: ${JSON.stringify(formData.timeSlots)} `);
      ...
      if (response.data.statusCode === 200) {
        return toast.success("Doctor details updated successfully.");
      }
    } catch (err) {
